...
public class SumaEnteros {
	...
	/**
	 * Calcula la suma de todos los numeros anteriores del numero pasado por
	 * parametro
	 * 
	 * @param numero
	 * @return Numero entero que es el resultado de la suma de todos los numeros
	 *         anteriores del numero pasado por parametro
	 */
	...
	public static int sumaEnteros(int numero1, int numero2) {
		...
		// Creamos la variable numeroBase y numero para almacenar el numero mas pequeño
		// y el mas grande

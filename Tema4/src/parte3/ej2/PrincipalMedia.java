...
public class PrincipalMedia {
	...
	public static void main(String[] args) {
		...
		// Creamos las variables enteras numero1 y numero2 para almacenar los dos
		// numeros enteros que introduzca el usuario
		int numero1Int;
		int numero2Int;

		// Creamos las variables doubles numero1 y numero2 para almacenar los dos
		// numeros decimales que introduzca el usuario

...
public class PrincipalNumerosAleatorios {
	...
	public static void main(String[] args) {
		...
		// Creamos la variable numero para almacenar el numero de numeros aleatorios a
		// generar
		int numero;

		// Creamos la variable min para almacenar el numero minimo del rango de los
		// numeros aleatorios
		int min;

		// Creamos la variable max para almacenar el numero maximo del rango de los
		// numeros aleatorios
		int max;
		...
		// Pedimos al usuario que introduzca el numero de numeros aleatorios que quiere
		// generar

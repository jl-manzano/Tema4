...
public class Libro {
	...
	// Creamos el atributo ejemplares para almacenar el numero de ejemplares del
	// libro
	private int ejemplares;

	// Creamos el atributo ejemplaresPrestados para almacenar el numero de
	...
	/**
	 * Constructor con titulo del libro, nombre del autor del libro, ejemplares y
	 * ejemplares prestados del libro
	 * 
	 * @param titulo              No puede ser nulo ni estar en blanco
	 * @param autor               No puede ser nulo ni estar en blanco
	 * @param ejemplares          Tiene que ser mayor que 0
	 * @param ejemplaresPrestados Tiene que ser menor o igual que el numero de
	 *                            ejemplares
	 */
	 ...
	 * @param ejemplares          Tiene que ser mayor que 0
	 * @param ejemplaresPrestados Tiene que ser menor o igual que el numero de
	 *                            ejemplares y mayor o igual que 0
	 * @param genero              Tiene que tener alguno de los siguientes valores:
	 *                            "narrativo", "lirico", "dramatico", "didactico" o
	 *                            "poetico"
	 */
	...
	/**
	 * Incrementa el atributo ejemplaresPrestados cada vez que se realice un
	 * prestamo
	 * 
	 * @param nEjemplaresPrestados Tiene que ser menor o igual que los ejemplares
	 *                             disponibles y mayor que 0
	 * @return True si es posible prestar la cantidad de libros indicada, false si
	 *         no lo es
	 */
	 ...
	 * 
	 * @param ejemplaresDevolver Tiene que ser menor o igual que los ejemplares
	 *                           prestados y mayor que 0
	 * @return True si es posible devolver la cantidad de libros indicada, false si
	 *         no lo es
	 */

...
public class PrincipalAlumno {
	...
	public static void main(String[] args) {
		...
		// Creamos la variable nombre para almacenar el nombre del alumno que introduzca
		// el usuario
		String nombre;
		...
		// Creamos la variable nota para almacenar la nota del alumno que introduzca el
		// usuario
		double nota;
